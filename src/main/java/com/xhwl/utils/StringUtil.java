...
public class StringUtil {
	 ...
	 */
	/*
	 * public static String ChineseStringToAscii(String s) { try {
	 * CharToByteConverter toByte = CharToByteConverter .getConverter("GBK");
	 * byte[] orig = toByte.convertAll(s.toCharArray()); char[] dest = new
	 * char[orig.length]; for (int i = 0; i < orig.length; i++) dest[i] = (char)
	 * (orig[i] & 0xFF); return new String(dest); } catch (Exception e) {
	 ...
	 */
	/*
	 * public static String ChineseStringToUTF(String s) { try {
	 ...
	 */
	/*
	 * public static String AsciiToChineseString(String s) { char[] orig =
	 * s.toCharArray(); byte[] dest = new byte[orig.length]; for (int i = 0; i <
	 * orig.length; i++) dest[i] = (byte) (orig[i] & 0xFF); try {
	 * ByteToCharConverter toChar = ByteToCharConverter .getConverter("GBK");
	 * return new String(toChar.convertAll(dest)); } catch (Exception e) {
	 * System.out.println(e); return s; } }
	 */
